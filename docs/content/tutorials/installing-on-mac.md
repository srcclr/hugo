...
1. Open <https://github.com/srcclr/hugo/releases> in your browser.
...
<https://github.com/srcclr/hugo/releases> and download the source code
...
```
git clone https://github.com/srcclr/hugo
```
...
ln -sf $(pwd) src/github.com/srcclr/hugo
