...
> **Note:** Do you know or maintain a similar project around Hugo? Feel free to open a [pull request](https://github.com/srcclr/hugo/pulls) on GitHub if you think it should be added.
