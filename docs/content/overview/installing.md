...
The latest release can be found at [Hugo Releases](https://github.com/srcclr/hugo/releases).
...
platform from [Hugo Releases](https://github.com/srcclr/hugo/releases).
...
* https://copr.fedorainfracloud.org/coprs/srcclr/hugo/ (updated to Hugo v0.16)
...
> More information is also available [in this related GitHub issue](https://github.com/srcclr/hugo/issues/3143).
...
`$HOME/go/src/github.com/srcclr/hugo`, and compile everything into a final `hugo`
